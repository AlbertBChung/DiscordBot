...
var getVids = function(searchString){
  return new Promise(function(resolve, reject){
    youTube.search(searchString, numOfOptions, function(error, result) {
      if (error) {
        reject(error);
      }
      else {
...
var play = function(connection, musicPlayer){
